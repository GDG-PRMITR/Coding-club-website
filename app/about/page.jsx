	 ...
	 return (
		 <div className="relative min-h-screen bg-white text-foreground overflow-x-hidden">
			 ...
			 <main className="py-12 px-4 flex flex-col items-center">
				 ...
				 <section className="max-w-4xl w-full bg-white rounded-xl shadow-lg p-8 mb-12 flex flex-col items-center">
					 <h1 className="text-5xl font-extrabold text-purple-700 mb-8 text-center">Coding Club</h1>
					 <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
						 <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
							 <h1 className="text-3xl font-extrabold text-purple-700 mb-4">Our Vision</h1>
...
and contributing to national growth in the global arena.”
				 ...
				 <section className="max-w-4xl w-full bg-white rounded-xl shadow-lg p-8">
					 <h2 className="text-3xl font-bold text-purple-700 mb-8 text-center">Communities</h2>
					 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						 <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
							 <img src="/Coding-Club.png" alt="GDGOC Logo" className="w-10 h-10 mb-2" />
							 <h3 className="font-semibold text-xl text-blue-700 mb-2">GDGOC</h3>

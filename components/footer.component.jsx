      ...
      <footer className="relative z-10 mt-16 bg-slate-900">
        <div className="container mx-auto px-6 py-12">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-blue-400 font-bold text-xl mb-2">Coding Club</h3>
              ...
              <div className="space-y-2 text-slate-300">
                <div className="flex items-center space-x-3">
                  <span className="text-blue-400"><MapPin className="w-4 h-4" /></span>
                  <span>Badnera, Maharashtra, India</span>
                </div>
                <div className="flex items-center space-x-3">
                  <span className="text-green-400"><Send className="w-4 h-4" /></span>
                  <span>info@prmit.ac.in</span>
                </div>
                <div className="flex items-center space-x-3">
                  <span className="text-yellow-400"><Phone className="w-4 h-4" /></span>
          ...
          <div className="border-t border-slate-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-slate-400 text-sm flex text-nowrap">Made with
                <span className="mx-1">❤️</span>
                by our web development team</span>
